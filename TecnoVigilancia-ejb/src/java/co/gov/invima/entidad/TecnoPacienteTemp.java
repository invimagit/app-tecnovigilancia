 ...
 */
@Entity
@Table(name = "tecno_paciente_temp")
@NamedQueries({@NamedQuery(name = "TecnoPacienteTemp.findAll", query = "SELECT t FROM TecnoPacienteTemp t"), @NamedQuery(name = "TecnoPacienteTemp.findByReporte", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.reporte = :reporte"), @NamedQuery(name = "TecnoPacienteTemp.findByIdentificacion", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.identificacion = :identificacion"), @NamedQuery(name = "TecnoPacienteTemp.findByTipidentificacion", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.tipidentificacion = :tipidentificacion"), @NamedQuery(name = "TecnoPacienteTemp.findByEdad", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.edad = :edad"), @NamedQuery(name = "TecnoPacienteTemp.findByGenero", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.genero = :genero"), @NamedQuery(name = "TecnoPacienteTemp.findByEdadEn", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.edadEn = :edadEn"), @NamedQuery(name = "TecnoPacienteTemp.findByInstitucionReportente", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.institucionReportente = :institucionReportente"), @NamedQuery(name = "TecnoPacienteTemp.findByNaturaleza", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.naturaleza = :naturaleza"), @NamedQuery(name = "TecnoPacienteTemp.findByDireccionReportante", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.direccionReportante = :direccionReportante"), @NamedQuery(name = "TecnoPacienteTemp.findByCodMun", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.codMun = :codMun"), @NamedQuery(name = "TecnoPacienteTemp.findByTelefonoReportante", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.telefonoReportante = :telefonoReportante"), @NamedQuery(name = "TecnoPacienteTemp.findByEmailReportante", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.emailReportante = :emailReportante"), @NamedQuery(name = "TecnoPacienteTemp.findByContactoReportante", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.contactoReportante = :contactoReportante"), @NamedQuery(name = "TecnoPacienteTemp.findByCodDepart", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.codDepart = :codDepart"), @NamedQuery(name = "TecnoPacienteTemp.findByInstitucionIncidente", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.institucionIncidente = :institucionIncidente"), @NamedQuery(name = "TecnoPacienteTemp.findByCodMun1", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.codMun1 = :codMun1"), @NamedQuery(name = "TecnoPacienteTemp.findByIdentificacion1", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.identificacion1 = :identificacion1"), @NamedQuery(name = "TecnoPacienteTemp.findByNivelComplejidad", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.nivelComplejidad = :nivelComplejidad"), @NamedQuery(name = "TecnoPacienteTemp.findByCargoInst", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.cargoInst = :cargoInst"), @NamedQuery(name = "TecnoPacienteTemp.findByFechaNotif", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.fechaNotif = :fechaNotif"), @NamedQuery(name = "TecnoPacienteTemp.findByCodDepart1", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.codDepart1 = :codDepart1"), @NamedQuery(name = "TecnoPacienteTemp.findByAutorizacion", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.autorizacion = :autorizacion"), @NamedQuery(name = "TecnoPacienteTemp.findByTipoReportante", query = "SELECT t FROM TecnoPacienteTemp t WHERE t.tipoReportante = :tipoReportante")})
public class TecnoPacienteTemp implements Serializable {
    ...
    public TecnoPacienteTemp() {
    }

    public TecnoPacienteTemp(String reporte) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TecnoPacienteTemp)) {
            return false;
        }
        TecnoPacienteTemp other = (TecnoPacienteTemp) object;
    ...
    public String toString() {
        return "co.gov.invima.entidad.TecnoPacienteTemp[reporte=" + reporte + "]";
    }
